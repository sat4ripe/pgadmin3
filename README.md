...
Будет поддерживаться не только оригинальная версия PostgreSQL и PostrgesPro Enterprise, но и PostgreSQL 10.

Полная версия pgAdmin3 находиться тут https://github.com/sat4ripe/pgadmin3.git

09.06.2024
  - Убрана ошибка 'av_replica' при работе с PostgreSQL 10.
  - 
01.11.2018
